...
print("Problem 1")
make_and_solve_tspproblem(desired_cities_1, distances)
print("Problem 2")
make_and_solve_tspproblem(desired_cities_2, distances)
print("Problem 3")
make_and_solve_tspproblem(desired_cities_3, distances)
print("Problem 4")
make_and_solve_tspproblem(desired_cities_4, distances)